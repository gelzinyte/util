...
wfl -v ref-method orca-eval  -o nm_displaced_100K_out.xyz -tmp "/scratch/eg475" -n 1 -p $NSLOTS --kw="n_hop=1 smearing=2000 maxiter=200 " --orca-simple-input "UKS B3LYP def2-SV(P) def2/J D3BJ" nm_displaced_100K.xyz 
