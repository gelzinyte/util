...
setup = """mol_non_opt_fn='mol_non_opt.xyz'
...
def sub_data(df_name, how_many, skip_first, submit, overwrite_sub,
             generate=False, optimise=False, modes=False,
             hours=48, no_cores=16, script_name='sub.sh'):
