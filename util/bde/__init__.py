...
def gap_prepare_bde_structures_multiple(smiles, gap_filename, gap_prop_prefix,
                                        etc):
    """using iterable_loop"""
    pass
...
def gap_prepare_bde_structures_single(smiles, name, calculator, gap_prop_prefix):
    ...
    # mol = process_info_labels(mol, name, 'mol')
